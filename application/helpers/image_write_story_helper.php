...
function imageUploadStory($uploadedImageObject, $userid, $imageid){
    $imageFile = $uploadedImageObject;
    ...
    $writePath= ROOT_DIR . 'static\\userdata\\images\\story\\'.$useridhash.'\\' . $imageidhash . '\\';
