...
class SiteContentModel extends Model {	
	...
	******************************************************************************************************************/	
	...
	public function getStoryQuestions()
	{
		...
		$storyQuestions = $this->fetchIntoClass($statement, null, "shared/DropDownViewModel");
	...
	public function getAnswersForQuestion($questionID)
	{
		...
		$dropdownValues = $this->fetchIntoClass($statement, array(":questionID" => $questionID), "shared/DropDownViewModel");
