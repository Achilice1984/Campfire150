                ...
                <div class="row">
                    ...
                    <div class="col-md-6"> 
                        ...
                        <div class="col-md-6">
                            ...
                            <button class="CancelProfileButton btn btn-danger btn-block" style="margin-top: 20px;"><span class="glyphicon glyphicon-remove"></span> <?php echo gettext("Close Edit Screen"); ?></button>
            ...
            <div class="row">
                <div class="col-md-6">                        
                    ...
                    <form id="changePasswordForm" action="<?php echo BASE_URL; ?>Account/changepassword" method="post">
                        ...
                        <div class="form-group">
                            <label for="Password"><?php echo gettext("New Password"); ?></label>
                            <input type="password" class="form-control" id="Password" name="Password" placeholder="<?php echo gettext("Enter Password"); ?>">
                        </div>
                        <div class="form-group">
                            <label for="RePassword"><?php echo gettext("Re-Type New Password"); ?></label>
