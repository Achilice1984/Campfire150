...
<section class="container">
    ...
    <div role="tabpanel">
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#celebrate" aria-controls="celebrate" role="tab" data-toggle="tab">Celebrate 150</a></li>
        <li role="presentation"><a href="#hostCampfire" aria-controls="hostCampfire" role="tab" data-toggle="tab">Host a Campfire</a></li>
        <li role="presentation"><a href="#volunteer" aria-controls="volunteer" role="tab" data-toggle="tab">Volunteer</a></li>
      </ul>
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="celebrate">
            <h2>Celebrate 150</h2>
        ...
        <div role="tabpanel" class="tab-pane" id="hostCampfire">
            ...
            <ul>
                <li>Help collect all the stories you share for Campfire150 with our handy-dandy <a href="#" data-toggle="tooltip" title="<? echo gettext("Opens in a new window"); ?>" target="_blank">mobile app</a></li>
                <li>Find the perfect <a href="#" data-toggle="tooltip" title="<? echo gettext("Opens in a new window"); ?>" target="_blank">Parks Canada</a> campfire pit to gather around</li>
                <li>Learn how to <a href="#" data-toggle="tooltip" title="<? echo gettext("Opens in a new window"); ?>" target="_blank">Build the perfect Campfire</a></li>
                <li>Download our guide on <a href="#" data-toggle="tooltip" title="<? echo gettext("Opens in a new window"); ?>" target="_blank">Hosting the perfect Campfire</a></li>
                <li>Can’t meet outside?  Check out the <a href="#" data-toggle="tooltip" title="<? echo gettext("Opens in a new window"); ?>" target="_blank">Virtual Campfire</a></li>
            </ul>
            <hr />
            <h2>What's Better Bananna Boat or S'more?</h2>
